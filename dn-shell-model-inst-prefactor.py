...
projectEtaPerp = True # always keep as true; if False, requires unique saddle point, which is not true for this model
...
class Instanton():
    ...
    # function that finds the first nEvals eigenvalues of the matrix B_z to approximate the determinant of the matrix.
...
if __name__ == '__main__':
    ...
    data_dir = '/Users/rawdata/Downloads/data/{}/pref_nu_{}_c1_{}_c2_{}_obs_{}_date_{}'.format(param, nu, c1, c2, targetObs, dt_string)
    ...
    if plots:
        ...
        plot_times = [0, 4, 8, 12, 15, 20, 30, 40, 50, 60, 80]
    ...
    ############################################################
    # calculate det(Id - A) via dominant eigs:
